...
void Sink::handleMessage(cMessage *msg)
{
    ...
    cModule* cMod = this->getParentModule()->getSubmodule("Coordinatore");
    Queue *coordinatore = check_and_cast<Queue*>(cMod);
    coordinatore->setAvatars(coordinatore->getAvatars()-1);
