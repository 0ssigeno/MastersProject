...
public class ComplexStaticAnalysisParser extends Parser {
	...
	public static final int
		...
		RULE_typeNode = 8, RULE_parameter = 9, RULE_expNode = 10, RULE_term = 11, 
		RULE_factor = 12, RULE_value = 13;
	private static String[] makeRuleNames() {
		return new String[] {
			"block", "statement", "assignment", "deletion", "print", "functioncall", 
			"ifthenelse", "declaration", "typeNode", "parameter", "expNode", "term", 
			"factor", "value"
		};
	}
	...
	public static class AssignmentContext extends ParserRuleContext {
		...
		public ExpNodeContext expNode() {
			return getRuleContext(ExpNodeContext.class,0);
		}
	...
	public static class FunctioncallContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(ComplexStaticAnalysisParser.ID, 0); }
		public List<ExpNodeContext> expNode() {
			return getRuleContexts(ExpNodeContext.class);
		}
		public ExpNodeContext expNode(int i) {
			return getRuleContext(ExpNodeContext.class,i);
		}
	...
	public static class TypeNodeContext extends ParserRuleContext {
		public TypeNodeContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_typeNode; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterTypeNode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitTypeNode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitTypeNode(this);
			else return visitor.visitChildren(this);
		}
	}

	public final TypeNodeContext typeNode() throws RecognitionException {
		TypeNodeContext _localctx = new TypeNodeContext(_ctx, getState());
		enterRule(_localctx, 16, RULE_typeNode);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class ExpNodeContext extends ParserRuleContext {
		public TermContext leftFactorNode;
		public ExpNodeContext rightTermNode;
		...
		public ExpNodeContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_expNode; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).enterExpNode(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ComplexStaticAnalysisListener ) ((ComplexStaticAnalysisListener)listener).exitExpNode(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ComplexStaticAnalysisVisitor ) return ((ComplexStaticAnalysisVisitor<? extends T>)visitor).visitExpNode(this);
			else return visitor.visitChildren(this);
		}
	}

	public final ExpNodeContext expNode() throws RecognitionException {
		ExpNodeContext _localctx = new ExpNodeContext(_ctx, getState());
		enterRule(_localctx, 20, RULE_expNode);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			setState(120);
			((ExpNodeContext)_localctx).leftFactorNode = term();
			setState(123);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__15 || _la==T__16) {
				...
				setState(122);
				((ExpNodeContext)_localctx).rightTermNode = expNode();
				}
			}
	...
	public static class TermContext extends ParserRuleContext {
		public FactorContext leftFactorNode;
		public TermContext rightTermNode;
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			{
			setState(125);
			((TermContext)_localctx).leftFactorNode = factor();
			setState(128);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__17 || _la==T__18) {
				...
				setState(127);
				((TermContext)_localctx).rightTermNode = term();
				}
			}
	...
	public static class FactorContext extends ParserRuleContext {
		public ValueContext leftFactorNode;
		public Token op;
		public ValueContext rightTermNode;
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(130);
				((FactorContext)_localctx).leftFactorNode = value();
				setState(133);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==ROP) {
					...
					setState(132);
					((FactorContext)_localctx).rightTermNode = value();
					}
				}
